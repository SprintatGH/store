								...
								<tr>
										...
										<div class="pdf-content-price-left">
											...
											<div class="pdf-content-price-row">
												...
												<div class="sub-price">
													...
													<small>DESCUENTO({{$ca_venta_cot->descuento}}%)</small>

													<span class="text-inverse">${{ number_format($descuento,0) }}</span>
									...
									<td style="width: 50px;">
										...
										<div class="pdf-content-total">
											...
											<small>TOTAL</small> <span class="f-w-600">${{ number_format($subtotal + $ca_venta_cot->valor_despacho - $descuento ,0) }}</span>
