...

				{
					...
					for (var i=0; i<data.length; i++){
						...
						info = [
							...
							"<a href='#' onclick='cambioEstado(this)' id='In' data-href='/cliente/administracion/clientes/" + data[i].id + "/0/estado'> <span  class='btn btn-xs btn-white m-b-10'><i class='fa fa-trash t-plus-1 text-success fa-fw fa-sm'></i></span></a>",

							"<a href='#' onclick='editar(this)'   data-href='/cliente/administracion/clientes/" + data[i].id + "/edit' data-toggle='modal' data-id='" + data[i].id + "' data-target='#modal-edit'>" + data[i].id  + "</a>", 
...

{
    ...
    var route = id.getAttribute("data-href");
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\jpabl\OneDrive\Escritorio\GitRepository\store\store\prod\resources\views/cliente/administracion/clientes/index.blade.php ENDPATH**/ ?>