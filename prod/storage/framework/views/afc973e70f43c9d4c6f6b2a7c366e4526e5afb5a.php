			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<p>
						...
						<form method="POST" action="<?php echo e(route('CA_EstadoPago.update')); ?>" class="form-horizontal" data-parsley-validate="true">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<p>
						...
						<form method="POST" action="<?php echo e(route('CA_EstadoPago.store')); ?>" class="form-horizontal" data-parsley-validate="true">
...
function getDataProductos(){
    ...
    var route = "<?php echo e(url('/cliente/ventas/parametros/DTestadoPago')); ?>";
...

{
    ...
    var route = "<?php echo e(url('/cliente/ventas/parametros/estadoPago')); ?>/"+id+"/edit";
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\jpabl\OneDrive\Escritorio\GitRepository\store\store\prod\resources\views/cliente/ventas/parametros/estadoPago.blade.php ENDPATH**/ ?>