										...
										<table id="grid" class="table table-striped" style="font-size: 9px;">
  											...
  											<thead>
  												...
  												<tr> 
													...
													<th class="text-nowrap">Tipo Pago</th>

													<th class="text-nowrap">Estado Pago</th> 
							...
							<?php echo csrf_field(); ?>
							 ...
							 <input type="hidden" id="edit_id" name="edit_id">
								...
								<div class="form-group row m-b-15">
									...
									<label class="col-md-4 col-sm-4 col-form-label" for="estado">Estado Pago:</label>

									<div class="col-md-8 col-sm-8">

										<select class="form-control" name="estadoPago" >

											<option id="pago_0" value="0" selected> Seleccione un estado de pago </option>

											<?php $__currentLoopData = $estadosPago; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

												<option id="pago_<?php echo e($items->id); ?>" value="<?php echo e($items->id); ?>"> <?php echo e($items->nombre); ?> </option>
								...
								<div class="form-group row m-b-15">
									...
									<div class="col-md-8 col-sm-8">
										...
										<select class="form-control" name="estadoPago" >
											...
											<option value="0" selected> Seleccione un estado de pago </option>
...

{
    ...
    $.get(route, function(content){
		...
		document.getElementById("pago_"+ content.estado_pago_id).selected = "true"; 
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\jpabl\OneDrive\Escritorio\GitRepository\store\store\prod\resources\views/cliente/ventas/controlDespacho/index.blade.php ENDPATH**/ ?>